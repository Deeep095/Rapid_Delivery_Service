...
class _LocationSearchSheetState extends State<LocationSearchSheet> {
  ...
  // =====================================================
  // TEST LOCATIONS - Pre-configured near warehouses
  // These match the warehouses in seed.py for testing
  // =====================================================
  static final List<UserLocation> _testLocations = [
    // Near wh_amer warehouse (Jaipur)
    UserLocation(
      name: "📍 LNMIIT Campus",
      address: "Test Location - Near Amer Warehouse (~5km)",
      lat: 26.9400,
      lon: 75.8400,
    ),
    // Near wh_rajapark warehouse (Jaipur)
    UserLocation(
      name: "📍 Raja Park",
      address: "Test Location - Near Raja Park Warehouse (~2km)",
      lat: 26.9050,
      lon: 75.8200,
    ),
    // Too far from any warehouse (>30km)
    UserLocation(
      name: "📍 Ajmer (Too Far)",
      address: "Test Location - No delivery available (>30km)",
      lat: 26.4500,
      lon: 74.6400,
    ),
  ];
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // =====================================================
          // QUICK TEST SECTION - Shows test locations when empty
          // =====================================================
